...
<div class="signup-form" style="padding-top: 43px;font-size:30px;padding-left:20px;text-align:center">
    ...
    <div class="form-group">
      ...
      <div class="form-group">
        ...
        <input type="date" id="date"  name="date" min="2023-01-01" max="2023-06-30" required>
      </div><br>
      <div class="form-group">
        <button class="glow-on-login"  type="submit" name="book"><a href="" style="font-size:20px">BOOK NOW</a></button>
      </div>
    </form>
  </div>
