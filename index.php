...
<header>
    ...
    <div class="action">
        <div class="profile">
            <a href="login.php" target="_blank" style="padding-left:17%">
    ...
    <div class="box-container">
        ...
        <div class="box">
            ...
            <div class="content">
                ...
                <a href="login.php" target="_blank" class="btn">see more</a>
            </div>
        </div>
        <div class="box">
...
<a href="login.php" target="_blank" class="btn">see more</a>
        ...
        <div class="box">
            ...
            <div class="content">
                <h3>Gandikota</h3>
                <p>Gandikota is a historic village which is characterized by its own fort, situated on the right bank of the River Penna.</p>
                <a href="login.html" target="_blank" class="btn">see more</a>
            </div>
        </div>
        <div class="box">
