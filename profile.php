...
<div class = "profile" style="padding-top: 43px;font-size:30px;padding-left:20px;text-align:center">
  <h1>Hello !! </h1>
  <h2 style="color:orange;font-family:algerian;padding-right:0px"><?php echo $fname.' '.$lname; ?></h2>
</div>

<div class = "profile" style="padding-top: 1px;font-size:30px;padding-right:100px;text-align:right">
  <h2>Your Email is ! </h2>
...
<div class = "profile" style="padding-top: 1px;font-size:30px;padding-right:80px;text-align:right">
