...
<header>
    ...
    <nav class="navbar">
        ...
        <a href="packages.php" target="_blank">Packages</a>
    ...
    <div class="box-container">
        ...
        <div class="box">
            ...
            <div class="content">
                ...
                <a href="packages.php" target="_blank" class="btn">book now</a>
            </div>
        </div>
...
<br></br>
<center><a href="packages.php" target="_blank" class="btn" style="font-size:50px">More</a></center>
</section>
    ...
    <div class="box-container">
        ...
        <div class="box">
            ...
            <div class="content">
                ...
                <a href="gallary.php" target="_blank" class="btn">see more</a>
            </div>
        </div>
        <div class="box">
